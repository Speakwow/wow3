...
import { getCharacterById, getRepeatThreadById, getScenarioById, getScenarioRecordByUserId } from "@/lib/action/mongoIO";
            ...
            <div className="flex justify-center">
                {!current ?
                    <div>当前无进行中课程</div> :
                        ...
                        <Card className="border-[#42C83C] border-2 rounded-[40px]">
                            <CardHeader>
