...
import { setOrgTextbook } from "@/lib/action/kv"
import { useRouter } from "next/navigation"

export default function TextbookSelector({ textbooks, orgId, currentBookId }: { textbooks: any[], orgId: string, currentBookId: string }) {
    ...
    function onSubmit(data: z.infer<typeof FormSchema>) {
        setOrgTextbook(orgId, data.bookId).then((res) => {
            toast({
                title: "保存成功",
            })
