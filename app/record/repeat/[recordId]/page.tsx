...
export default async function RecordInfo({ params }: { params: { recordId: string } }) {
    ...
    return (
        <ScrollArea className="w-full h-full mb-4  bg-neutral-100">
            <div className="p-8 h-full flex flex-col">
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/">成绩详情</BreadcrumbLink>  {/* uri missing */}
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                ...
                <div className=" grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mt-4 mb-10">
