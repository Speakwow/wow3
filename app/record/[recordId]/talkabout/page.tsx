...
export default async function RecordInfo({ params }: { params: { recordId: string } }) {
    ...
    try {
        ...
        if (record !== null) {
            ...
            const tAccuracy = record.accuracy;
            const tFluency = record.fluency;
            const tGram = record.grammarScore;
            const tContent = record.overallContentScore;
            const tPron = record.overallPronScore;
            const tTheme = record.themeScore;
            const tVocab = record.vocabScore;
            comment = record.feedback;
            stuAns = record.user_answer;
    ...
    return (
        <div className="relative w-full h-full flex flex-col bg-neutral-100">
            ...
            <ScrollArea className="w-full h-full mb-4">
                <div className=" grid auto-rows-max grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mt-4 mb-10">
                    <Card className=" col-span-2 row-span-2 w-full pb-2">
                        ...
                        <CardContent className="flex gap-4 p-4">
                            ...
                            <div className="grid flex-1 auto-rows-min gap-0.5">
                                <div className="text-sm text-muted-foreground">Prepare Time</div>
                                <div className="flex items-baseline gap-1 text-lg font-bold tabular-nums leading-none pt-3">
                                    {prepTime}
                                </div>
                            </div>
                    ...
                    <Card className="w-full pb-2">
                        ...
                        <CardFooter className="flex flex-row border-t p-4">
                            <div className="flex w-full items-center gap-2">
                                <div className="grid flex-1 auto-rows-min gap-0.5">
                                    <div className="text-xs text-muted-foreground">Content 内容</div>
                                    <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                                ...
                                <Separator orientation="vertical" className="mx-2 h-10 w-px" />
                                <div className="grid flex-1 auto-rows-min gap-0.5">
                                    <div className="text-xs text-muted-foreground">Pronouciation 發音</div>
                                    <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                    ...
                    <Card className="w-full pb-2">
                        <CardHeader className="p-4 pb-0">
                            <CardTitle className="text-md">語法</CardTitle>
                            <CardDescription className="text-xs">
                                Organisation
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card className="w-full pb-2">
                        ...
                        <CardFooter className="flex flex-row border-t p-4">
                            <div className="flex w-full items-center gap-2">
                                <div className="grid flex-1 auto-rows-min gap-0.5">
                                    <div className="text-xs text-muted-foreground">Theme 貼題</div>
                                    <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                                ...
                                <Separator orientation="vertical" className="mx-2 h-10 w-px" />
                                <div className="grid flex-1 auto-rows-min gap-0.5">
                                    <div className="text-xs text-muted-foreground">Vocabulary 詞匯</div>
                                    <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
                ...
                <div className=" grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 mb-10">
                    <Card className=" w-full pb-2 mt-4">
                        <CardHeader className="p-4 pb-0">
                            <CardTitle className="text-md">學生回答</CardTitle>
                        </CardHeader>
                        <CardContent className="flex flex-row items-baseline gap-4 p-4 pt-0 mt-2">
                            <div className="flex items-baseline gap-1 text-md tabular-nums leading-none">
                                {overallScore[8]}
